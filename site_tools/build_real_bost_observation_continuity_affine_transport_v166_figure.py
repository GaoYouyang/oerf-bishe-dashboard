#!/usr/bin/env python3
"""Build the public v166 continuity-affine transport decision matrix."""
...
OUTPUT = ROOT / "assets/figures/real_bost_observation_continuity_affine_transport_v166.png"
WIDTH = 2520
HEIGHT = 1180
...
def main() -> int:
    ...
    _text(
        draw,
        (WIDTH / 2, 62),
        "v166 mass-conserving global affine transport",
        size=44,
        fill="#17232d",
        bold=True,
        anchor="mm",
    ...
    _text(
        draw,
        (WIDTH / 2, 1077),
        "Independent verdict: 10/12 pass; mass conservation does not rescue both five-camera gradient tails.",
        size=25,
        fill="#7a3f2d",
        bold=True,
        anchor="mm",
    ...
    _text(
        draw,
        (WIDTH / 2, 1112),
        "t=0.75: 0.796 / 1.060 | 13A+1AT | 53/53 checks pass | global affine continuity family closed",
        size=21,
        fill="#66737e",
        anchor="mm",
    )
