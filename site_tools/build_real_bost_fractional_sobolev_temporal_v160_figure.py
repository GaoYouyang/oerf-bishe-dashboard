#!/usr/bin/env python3
"""Build the public v160 fractional-Sobolev decision matrix."""
...
OUTPUT = ROOT / "assets/figures/real_bost_fractional_sobolev_temporal_v160.png"
WIDTH = 2520
HEIGHT = 1180
...
def main() -> int:
    ...
    _text(draw, (WIDTH / 2, 62), "v160 half-order Sobolev diagnostic", size=44, fill="#17232d", bold=True, anchor="mm")
    ...
    _text(draw, (WIDTH / 2, 1077), "Independent verdict: 8/12 pass; all four five-camera gradient tails fail and worsen versus H1.", size=25, fill="#5f4932", bold=True, anchor="mm")
    _text(draw, (WIDTH / 2, 1112), "oversmoothing hypothesis rejected | controlled proxy | no predictor, GPU, or speed claim", size=21, fill="#66737e", anchor="mm")
