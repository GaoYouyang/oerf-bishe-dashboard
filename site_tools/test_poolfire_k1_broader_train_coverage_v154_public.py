...
def test_current_evidence_closes_current_predictor_and_gpu() -> None:
    ...
    assert payload["scientific_status"] == "FAIL_SPECTRAL_SMOOTHNESS_REFERENCE_V158"
    assert "genuinely new three-dimensional fields" in payload["next_scientific_gate_en"]
