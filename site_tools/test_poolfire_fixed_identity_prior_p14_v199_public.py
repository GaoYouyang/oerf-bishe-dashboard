...
def test_v199_evidence_remains_preserved_after_v201_becomes_current() -> None:
    ...
    assert current["formal_status"] == "FORMAL_PENDING_INDEPENDENT_OBSERVATION_SPECTRAL_PROXY_V214"
    assert current["engineering_status"] == "PASS_INDEPENDENT_RECOMPUTATION_OBSERVATION_SPECTRAL_PROXY_V214"
