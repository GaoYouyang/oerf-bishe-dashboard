...
def test_v199_evidence_remains_preserved_after_v201_becomes_current() -> None:
    ...
    assert current["formal_status"] == "FORMAL_PENDING_INDEPENDENT_SOURCE_WEIGHTED_OBSERVABILITY_V213_1"
    assert current["engineering_status"] == "PASS_INDEPENDENT_RECOMPUTATION_SOURCE_WEIGHTED_OBSERVABILITY_V213_1"
