...
def test_v261_remains_preserved_after_v263_1_on_bilingual_primary_pages() -> None:
    ...
    assert current["headline_zh"].startswith("v274.2")
    assert current["headline_en"].startswith("v274.2")
    ...
    assert current["public_evidence"]["figure"].endswith("blastnet_case19_loro_fusion_reference_v274_2.png")
