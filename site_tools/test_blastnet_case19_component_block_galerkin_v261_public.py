...
def test_v261_remains_preserved_after_v263_1_on_bilingual_primary_pages() -> None:
    ...
    assert current["headline_zh"].startswith("v269.1")
    assert current["headline_en"].startswith("v269.1")
    assert "0/13" in current["headline_zh"] and "13/13" in current["headline_en"]
