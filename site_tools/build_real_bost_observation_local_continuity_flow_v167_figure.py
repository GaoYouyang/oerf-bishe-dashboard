#!/usr/bin/env python3
"""Build the public v167 local-continuity decision matrix."""
...
OUTPUT = ROOT / "assets/figures/real_bost_observation_local_continuity_flow_v167.png"
WIDTH = 2520
HEIGHT = 1180
...
def main() -> int:
    ...
    _text(
        draw,
        (WIDTH / 2, 62),
        "v167 four-region local continuity flow",
        size=44,
        fill="#17232d",
        bold=True,
        anchor="mm",
    ...
    _text(
        draw,
        (WIDTH / 2, 1077),
        "Independent verdict: 10/12 pass; fixed local continuity does not repair late five-camera gradients.",
        size=25,
        fill="#7a3f2d",
        bold=True,
        anchor="mm",
    ...
    _text(
        draw,
        (WIDTH / 2, 1112),
        "t=0.75: 0.813 / 1.146 | 13A+1AT | 58/58 checks pass | worse than v166 and frozen H1",
        size=21,
        fill="#66737e",
        anchor="mm",
    )
