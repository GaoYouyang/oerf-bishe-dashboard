...
def test_v235_historical_surfaces_and_log_remain_synchronized_after_v239() -> None:
    ...
    assert "fixed low-rank coordinate map" in current["next_scientific_gate"].lower()
    assert "case7_jacobi_canonical_tail_subspace_capacity_v239" in (
