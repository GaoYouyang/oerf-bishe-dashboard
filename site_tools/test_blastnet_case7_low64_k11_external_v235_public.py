...
def test_v235_historical_surfaces_and_log_remain_synchronized_after_v237_2() -> None:
    ...
    assert "fixed low-rank maps" in current["next_scientific_gate"].lower()
    assert "case7_causal_krylov_recycling_v237_2" in (
