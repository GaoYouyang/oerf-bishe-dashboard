...
def test_v235_historical_surfaces_and_log_remain_synchronized_after_v240() -> None:
    ...
    assert "reachable linear span" in current["next_scientific_gate"].lower()
    assert "case7_causal_reachable_span_capacity_v240" in (
