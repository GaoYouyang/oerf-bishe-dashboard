#!/usr/bin/env python3
"""Build the public v159.1 temporal-transfer decision matrix."""
...
OUTPUT = ROOT / "assets/figures/real_bost_virtual_temporal_reference_transfer_v159.png"
WIDTH = 2520
HEIGHT = 1180
...
def main() -> int:
    ...
    _text(draw, (WIDTH / 2, 62), "v159.1 fixed-regularization temporal transfer", size=44, fill="#17232d", bold=True, anchor="mm")
    ...
    _text(draw, (WIDTH / 2, 1077), "Independent verdict: 11/12 strata pass; t=0.75 with 5 cameras misses gradient p90 by 0.008639.", size=25, fill="#5f4932", bold=True, anchor="mm")
    _text(draw, (WIDTH / 2, 1112), "controlled virtual proxy | no paired experimental 2D displacement | no predictor, GPU, or speed claim", size=21, fill="#66737e", anchor="mm")
