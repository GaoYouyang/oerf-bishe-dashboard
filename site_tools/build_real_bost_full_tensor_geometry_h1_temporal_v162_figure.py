#!/usr/bin/env python3
"""Build the public v162 full-tensor geometry decision matrix."""
...
OUTPUT = ROOT / "assets/figures/real_bost_full_tensor_geometry_h1_temporal_v162.png"
WIDTH = 2520
HEIGHT = 1180
...
def main() -> int:
    ...
    _text(draw, (WIDTH / 2, 62), "v162 full-tensor geometry-coupled H1", size=44, fill="#17232d", bold=True, anchor="mm")
    ...
    _text(draw, (WIDTH / 2, 1077), "Independent verdict: 11/12 pass; t=0.75 at five cameras misses the gradient gate by 0.001035.", size=25, fill="#5f4932", bold=True, anchor="mm")
    _text(draw, (WIDTH / 2, 1112), "0.751035 vs isotropic H1 0.758639 and diagonal H1 0.768197 | global quadratic geometry family closed", size=21, fill="#66737e", anchor="mm")
