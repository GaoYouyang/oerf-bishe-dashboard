...
def main():
    ...
    arms = [('transport75', 'Learned 75', '#c83242'),
            ('fixed_transport', 'Fixed transport', '#767676'),
    ...
    fig.suptitle('Trained 75-parameter model: 0/505 at the four-metric 1% gate', fontsize=14)
