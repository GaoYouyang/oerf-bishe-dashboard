window.OPERATOR_LEARNING_GUIDE = {
  version: "2026.07.24-c-second-additional-trajectory-ready",
  updated: "2026-07-24",
  foundationChecks: [
    {
      id: "python-array",
  ...
  resources: [
    ...
    {id:"poolfire-trajectory-protocol",stage:"data",level:"必做",type:"主线数据协议",title:"PoolFire 11/2/2 完整轨迹协议",url:"../document_reader.html?doc=docs%2Fpoolfire_trajectory_protocol_evidence_2026-07-23.md",local:"",read:"先看 15 条官方 trajectory 的 train/validation/test 角色，再核对原始路径、字节数、SHA、test lockout、combination holdout 与 OOD 禁止声明。",output:"不看页面画出 11/2/2 角色图，并解释为什么同一轨迹随机切帧不是泛化、为什么两条 test 不是 unseen-power OOD。",verified:"PASS_FROZEN_POOLFIRE_TRAJECTORY_PROTOCOL；PASS_SECOND_ADDITIONAL_TRAIN_TRAJECTORY_READY；p=33kw_size=01 与 p=45kw_size=05 的字节数/SHA、ZIP/NPY、full-resolution rho、checksums/READY 全过；test_truth_opened=false；29 项定向测试通过"},
