window.OPERATOR_LEARNING_GUIDE = {
  version: "2026.08.02-c-v101-reference-capacity-pass-rank0-control",
  previousVersion: "2026.08.02-c-v100-endpoint-space-fail-v101-reference-gate",
  ...
  resources: [
    ...
    {id:"nine-view-v101-reference-truth-capacity",stage:"geometry",level:"必做",type:"最新公共参考域容量正结果",title:"v101：公共物理 rank 0 与 rank 4 都是 90/90，但预测价值未证",url:"../document_reader.html?doc=docs%2Fnine_view_case6_reference_truth_blend_loo_capacity_v101_result_2026-08-02.md",local:"../docs/nine_view_case6_reference_truth_blend_loo_capacity_v101_public_summary.json",read:"先比较 anchor 20/90、matched endpoint rank4 37/90、physical rank0 90/90 与 physical rank4 90/90，再核对独立程序重建 15 折、43 arms、3870 次 strict K1 后所有正式差值为 0。重点理解为什么公共物理目标选择成功，却不能直接把 rank4 oracle 写成可部署模型。",output:"不用页面解释：v99、v100、v101 三步怎样把师兄的微分同胚建议落到 BOST；rank0 为什么是必须击败的强基线；rank4 在 field/full-gradient 90/90 更好但 maximum-gate 只 63/90 更好意味着什么；下一门为何仍不租 GPU。",verified:"PASS_REFERENCE_TRUTH_BLEND_CAPACITY_V101；PASS_INDEPENDENT_RECOMPUTATION_REFERENCE_TRUTH_BLEND_CAPACITY_V101；rank0 90/90；rank4 90/90；matched endpoint rank4 37/90；formal-independent max difference 0；algorithm_breakthrough=false"},
