window.OPERATOR_LEARNING_GUIDE = {
  version: "2026.08.02-c-v91-basis-invariant-physical-ball",
  ...
  resources: [
    {id:"nine-view-v91-case6-basis-invariant-physical-ball",stage:"warm-start",level:"必做",type:"最新参数化诊断正进展",title:"v91：同一九维方向空间排除系数盒后达到 89/90",url:"../document_reader.html?doc=docs%2Fnine_view_v90_case6_basis_invariant_physical_ball_v91_result_2026-08-02.md",local:"../docs/nine_view_v90_case6_basis_invariant_physical_ball_v91_public_summary.json",read:"先理解为什么坐标逐项的 [-1,1]^9 约束依赖基选择，再理解由物理 correction Gram 定义的能量球为何基不变。重点核对没有新增方向、F30+/7 与 F30+/9 的 witness 为什么落在旧盒外、F30+/12 为什么仍越线 3.688%，以及独立程序如何重建 Gram 和搜索。",output:"不用页面解释：为什么 v91 证明 v90 有两个假阴性；为什么这要求撤回宽泛关线却仍不是算法突破；为什么下一门只为一个剩余单元增加最小局部或多尺度方向；为什么当前仍不租 GPU。",verified:"NO_ALL_CELL_SAME_SPAN_PHYSICAL_BALL_WITNESS_FOUND_V91；PASS_INDEPENDENT_RECOMPUTATION_CASE6_PHYSICAL_BALL_V91；89 witnesses / 1 unresolved / 2 repaired；algorithm_breakthrough=false"},
