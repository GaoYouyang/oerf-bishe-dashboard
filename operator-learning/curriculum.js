window.OPERATOR_LEARNING_GUIDE = {
  version: "2026.07.26-c-v9-3-lineage-and-geok-novelty",
  updated: "2026-07-26",
  foundationChecks: [
    {
      id: "python-array",
  ...
  resources: [
    ...
    {id:"poolfire-c-objective-novelty",stage:"warm-start",level:"必做",type:"优化目标与原创性护栏",title:"GEOK-Warm 目标、近邻与六道新颖性门",url:"../document_reader.html?doc=docs%2Fpoolfire_c_objective_and_novelty_guardrail_2026-07-26.md",local:"",read:"先按精度→A/A^T→wall→RSS 的顺序写出目标，再对照 NeRIF、NeDF、learned warm starts、NOWS、FCG-NO、Spectrally Safe Warm Starts 和七项专利近邻；最后手推为什么 q0/q1 线性组合留在 Range(A^T)。",output:"写一页 claim chart：哪些组件不新、GEOK-Warm 的结构差异、四个理论命题、六个论文门和三个必须向师兄确认的问题。",verified:"一级来源与 Google Patents 权利要求初筛；完整组合暂未发现同构先例，但不构成全球唯一或法律自由实施保证；Cross14=sentinel；algorithm_breakthrough=false"},
