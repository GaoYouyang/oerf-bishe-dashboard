window.OPERATOR_LEARNING_GUIDE = {
  ...
  previousBadge: "v68.3 fresh resource · wall PASS / RSS FAIL",
  ...
  resources: [
    ...
    {id:"nine-view-stencil-factor-stageb-v70",stage:"warm-start",level:"必做",type:"最新精度正结果",title:"v70 exact-stencil tiled p0：低内存候选全轨迹 PASS",url:"../document_reader.html?doc=docs%2Fnine_view_stencil_factor_stageb_v70_result_2026-07-31.md",local:"../docs/nine_view_stencil_factor_stageb_v70_public_summary.json",read:"先从v68.3的约168 MiB setup高水位差定位重复ray bundle与完整block，再核对exact-stencil复用、四行tile、p0 randomized SVD和不变的2A+2A^T重建账；最后区分1,515/1,515精度PASS与尚未运行的fresh资源门。",output:"不用页面解释：为什么12 MiB只是主导数组上界而不是RSS结果；为什么三组Pareto的0.80093 RSS比只能选候选；为什么dense p0独立复算最大差5.68e-14才真正授权Stage C。",verified:"PASS_INDEPENDENT_RECOMPUTATION_TILED_EXACT_P0_STAGE_B_V70；1,515/1,515；failed=0；fresh resource authorized but not run；algorithm_breakthrough=false"},
