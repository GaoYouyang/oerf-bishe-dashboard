window.OPERATOR_LEARNING_GUIDE = {
  version: "2026.08.02-c-v104-diffeomorphic-coarse-grid-invalid-high-resolution-next",
  previousVersion: "2026.08.02-c-v102-reference-rank4-predictor-no-advantage",
  previousBadge: "v102 correct transport 90/90 · eligible advantage 0/3",
  ...
  resources: [
    {id:"diffeomorphic-bost-novelty-audit",stage:"geometry",level:"必做",type:"一级来源创新边界",title:"微分同胚怎样真正进入 BOST：近邻工作、物理接口与必做对照",url:"../document_reader.html?doc=docs%2Fdiffeomorphic_bost_operator_novelty_audit_2026-08-02.md",local:"../docs/diffeomorphic_bost_operator_novelty_audit_2026-08-02.md",read:"对照 DNO、Geo-FNO、DIMON、ACT 与 diffeomorphic operator work，区分公共参考域思想、协梯度输运、相机 ray/detector basis 和 BOST exact adjoint。重点理解为何微分同胚本身不是创新，以及限定来源审计为什么不能写成全球首个。",output:"不用页面解释：现有方法覆盖了哪些组件；本项目还剩哪个窄而真实的 BOST-specific 缺口；论文必须保留哪些 no-warp、wrong-warp、geometry-ID、continuous-pose 和 reference-domain controls。",verified:"primary-source bounded audit；no fully isomorphic public method found within reviewed scope；global uniqueness not proven；algorithm_breakthrough=false"},
