...
This checksum-bound package compares one unregularized CGLS path with 27 fixed
quadratic L2, H1, and mixed Sobolev configurations on the already-opened validation
split. Every path uses exactly `24F/24A^T`; six checkpoints are scored.

- validation cases: `24`
- configurations: `28`
- scored rows: `4032`
- pilot-signal points: `2`
